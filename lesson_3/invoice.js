...
// addPayment(payment)
// addPayments(array of payments)
// amountDue(total minus each payment total)
...
function createInvoice(services = {}) {
  return {
    ...
    addPayments(paymentArray) {
      this.payments.push(...paymentArray);
    },
...
function createPayment(services = {}) {
  return {
    ...
    total() {
      return services.hasOwnProperty('amount') ? 
        services.amount : this.phone + this.internet;
    },
  };
}
...
console.log(invoice.amountDue() === 0);       // this should return 0
